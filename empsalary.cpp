...
for(i=0;i<n;i++)
{
 cout<<a[i].name<<setw(20)<<a[i].employee_ID<<setw(18)<<a[i].mb<<setw(18)<<a[i].employee_designation<<endl;
}
...
cout<<"basic salary"<<setw(20);cout<<"DA"<<setw(20);cout<<"hra"<<setw(20);cout<<"gross salary"<<endl;

for(i=0;i<n;i++)
{
  cout<<a[i].basic_salary<<setw(20);cout<<a[i].da<<setw(20);cout<<a[i].hra<<setw(20);cout<<a[i].gross_salary<<endl;
}
cout<<endl;
}
